# Forge — Reference-Oracle Differential Testing (Layer I completion) — Design Spec

**Status:** Approved (2026-06-27). Completes **Layer I** of the verification moat ([design spec](2026-06-26-forge-design.md) §"Verification subsystem"): property/metamorphic tests shipped in v2.4; this adds the **reference-oracle-by-simplicity** half.
...
- **Standalone:** `forge oracle <solution_dir> <goal_file>` — generate a reference and differential-test any solution; prints agreement + any counterexample.
...
- CLI: `forge oracle` offline via a monkeypatched client → prints agreement.
