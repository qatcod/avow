# Forge v1 (Skeleton) Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Build the smallest Forge that closes the loop end-to-end: an Examiner agent writes a frozen acceptance-test suite from a goal, a Builder agent (headless `claude -p`) edits code in an isolated workspace until those tests pass, with a deterministic outer loop enforcing non-regression, budget caps, and stop conditions — all observable in a run log.
...
- Project home: `/Users/qatadaha/Coding/forge/`. Package: `forge/`. Tests: `tests/`.
...
**Files:**
- Create: `/Users/qatadaha/Coding/forge/pyproject.toml`
- Create: `/Users/qatadaha/Coding/forge/forge/__init__.py`
- Create: `/Users/qatadaha/Coding/forge/forge/config.py`
- Create: `/Users/qatadaha/Coding/forge/tests/__init__.py`
- Test: `/Users/qatadaha/Coding/forge/tests/test_config.py`
...
Run: `cd /Users/qatadaha/Coding/forge && python -m pytest tests/test_config.py -q`
...
Run: `cd /Users/qatadaha/Coding/forge && pip install -e ".[dev]" && python -m pytest tests/test_config.py -q`
Expected: PASS (3 passed).

- [ ] **Step 7: Prepare commit** (run only when greenlit)

```bash
cd /Users/qatadaha/Coding/forge && git add pyproject.toml forge/__init__.py forge/config.py tests/__init__.py tests/test_config.py && git commit -m "feat: scaffold forge package and RunConfig"
```
...
**Files:**
- Create: `/Users/qatadaha/Coding/forge/forge/scoring.py`
- Test: `/Users/qatadaha/Coding/forge/tests/test_scoring.py`
...
Run: `cd /Users/qatadaha/Coding/forge && python -m pytest tests/test_scoring.py -q`
Expected: FAIL — `ModuleNotFoundError: No module named 'forge.scoring'`.
...
```bash
cd /Users/qatadaha/Coding/forge && git add forge/scoring.py tests/test_scoring.py && git commit -m "feat: parse pytest-json-report into TestResult with score/is_green"
```
...
**Files:**
- Create: `/Users/qatadaha/Coding/forge/forge/budget.py`
- Test: `/Users/qatadaha/Coding/forge/tests/test_budget.py`
...
import pytest
from forge.budget import Budget, PRICES
...
Run: `cd /Users/qatadaha/Coding/forge && python -m pytest tests/test_budget.py -q`
Expected: FAIL — `ModuleNotFoundError: No module named 'forge.budget'`.
...
```bash
cd /Users/qatadaha/Coding/forge && git add forge/budget.py tests/test_budget.py && git commit -m "feat: Budget with hard cost/iteration/wall-clock caps"
```
...
**Files:**
- Create: `/Users/qatadaha/Coding/forge/forge/memory.py`
- Test: `/Users/qatadaha/Coding/forge/tests/test_memory.py`
...
Run: `cd /Users/qatadaha/Coding/forge && python -m pytest tests/test_memory.py -q`
Expected: FAIL — `ModuleNotFoundError: No module named 'forge.memory'`.
...
```bash
cd /Users/qatadaha/Coding/forge && git add forge/memory.py tests/test_memory.py && git commit -m "feat: append-only JSONL run log"
```
...
**Files:**
- Create: `/Users/qatadaha/Coding/forge/forge/workspace.py`
- Test: `/Users/qatadaha/Coding/forge/tests/test_workspace.py`
...
Run: `cd /Users/qatadaha/Coding/forge && python -m pytest tests/test_workspace.py -q`
Expected: FAIL — `ModuleNotFoundError: No module named 'forge.workspace'`.
...
```bash
cd /Users/qatadaha/Coding/forge && git add forge/workspace.py tests/test_workspace.py && git commit -m "feat: snapshot-based Workspace with non-regression promote/reseed"
```
...
**Files:**
- Create: `/Users/qatadaha/Coding/forge/forge/runner.py`
- Test: `/Users/qatadaha/Coding/forge/tests/test_runner.py`

**Interfaces:**
- Consumes: `TestResult`/`parse_report` from `forge.scoring`.
...
Run: `cd /Users/qatadaha/Coding/forge && python -m pytest tests/test_runner.py -q`
Expected: FAIL — `ModuleNotFoundError: No module named 'forge.runner'`.
...
```bash
cd /Users/qatadaha/Coding/forge && git add forge/runner.py tests/test_runner.py && git commit -m "feat: Runner restores frozen tests and runs pytest into a TestResult"
```
...
**Files:**
- Create: `/Users/qatadaha/Coding/forge/forge/examiner.py`
- Test: `/Users/qatadaha/Coding/forge/tests/test_examiner.py`
...
from forge.examiner import Examiner, TestSuite, TestFile, split_suite
...
Run: `cd /Users/qatadaha/Coding/forge && python -m pytest tests/test_examiner.py -q`
Expected: FAIL — `ModuleNotFoundError: No module named 'forge.examiner'`.
...
```bash
cd /Users/qatadaha/Coding/forge && git add forge/examiner.py tests/test_examiner.py && git commit -m "feat: Examiner writes adversarial test suite via structured outputs; deterministic holdout split"
```
...
**Files:**
- Create: `/Users/qatadaha/Coding/forge/forge/builder.py`
- Test: `/Users/qatadaha/Coding/forge/tests/test_builder.py`

**Interfaces:**
- Consumes: `FailureInfo` from `forge.scoring`.
...
Run: `cd /Users/qatadaha/Coding/forge && python -m pytest tests/test_builder.py -q`
Expected: FAIL — `ModuleNotFoundError: No module named 'forge.builder'`.
...
```bash
cd /Users/qatadaha/Coding/forge && git add forge/builder.py tests/test_builder.py && git commit -m "feat: Builder drives headless claude -p with injectable runner"
```
...
**Files:**
- Create: `/Users/qatadaha/Coding/forge/forge/loop.py`
- Test: `/Users/qatadaha/Coding/forge/tests/test_loop.py`
...
Run: `cd /Users/qatadaha/Coding/forge && python -m pytest tests/test_loop.py -q`
Expected: FAIL — `ModuleNotFoundError: No module named 'forge.loop'`.
...
Run: `cd /Users/qatadaha/Coding/forge && python -m pytest -q`
Expected: PASS (all tasks' tests green).

- [ ] **Step 6: Prepare commit** (run only when greenlit)

```bash
cd /Users/qatadaha/Coding/forge && git add forge/loop.py tests/test_loop.py && git commit -m "feat: iterative solve() loop with non-regression, holdout check, and stop conditions"
```

---

### Task 10: CLI — `forge solve <goal-dir>`

**Files:**
- Create: `/Users/qatadaha/Coding/forge/forge/cli.py`
- Test: `/Users/qatadaha/Coding/forge/tests/test_cli.py`

**Interfaces:**
- Consumes: everything above.
- Produces: `build_examiner(config) -> Examiner` (constructs an `anthropic.Anthropic()` client) and `main(argv: list[str] | None = None) -> int`. CLI: `forge solve <goal-dir> [--config forge.yaml] [--no-regenerate] [--yes]`. Without `--yes`, after the Examiner writes the suite the CLI prints the test plan and pauses for confirmation before the build loop (the one human gate on the verifier). `--no-regenerate` reuses existing `tests_frozen/` and skips the Examiner.
...
Run: `cd /Users/qatadaha/Coding/forge && python -m pytest tests/test_cli.py -q`
...
Run: `cd /Users/qatadaha/Coding/forge && python -m pytest -q && forge --help`
Expected: all tests PASS; `forge --help` prints usage with the `solve` subcommand.

- [ ] **Step 6: Prepare commit** (run only when greenlit)

```bash
cd /Users/qatadaha/Coding/forge && git add forge/cli.py tests/test_cli.py && git commit -m "feat: forge solve CLI with human approval gate on the generated test plan"
```
...
1. Create a goal dir: `mkdir -p ~/Coding/forge-demo && printf 'Build a module `lib.py` exposing `def slugify(s: str) -> str` that lowercases, trims, and replaces runs of non-alphanumeric characters with single hyphens.' > ~/Coding/forge-demo/goal.md`
2. Ensure `claude` is installed/authenticated and `ANTHROPIC_API_KEY` is set (Examiner uses the SDK; Builder uses the CLI).
3. Run: `forge solve ~/Coding/forge-demo`
4. Approve the printed test plan, then watch `~/Coding/forge-demo/.forge/run.jsonl` — score should climb to 1.0 and the run should end `success=True reason=green`.
5. Inspect `~/Coding/forge-demo/.forge/best/lib.py` — the autonomously-built, test-passing artifact.
